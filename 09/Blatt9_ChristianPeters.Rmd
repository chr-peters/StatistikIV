...
Visualize the data as well as the decision boundaries for the lda as well as for the qda

```{r echo = FALSE}
plot(train$X1, train$X2, col = train$Class + 1, xlab = 'X1', ylab = 'X2', ylim = c(-4.5, 6.5))
